...
transformed parameters{
  ...
  //put inverse gamma prior on the scaled of sigma squared, otherwise put gamma prior on the scale of sigma itself
...
model {
  ...
  if(prior_scale==1){ //inverse gamma (on scale^2)
